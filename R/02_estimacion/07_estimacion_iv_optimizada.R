...
write_csv(diagnosticos, here::here("outputs", "reportes_intermedios", "diagnosticos_iv_comparacion.csv"))
...
write_csv(panel_export, here::here("data", "panel_con_ivs_optimizados.csv"))
