...
write_csv(resultados, here::here("outputs", "reportes_intermedios", "resultados_modelo_optimizado.csv"))
write_csv(diagnosticos, here::here("outputs", "reportes_intermedios", "diagnosticos_adicionales.csv"))
