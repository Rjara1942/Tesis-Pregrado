...
PATH_ENV <- here::here("data", "base_integrada3_IV.csv")
...
# 8. GUARDAR
# ==============================================================================
write_csv(df_panel, here::here("data", "panel_complejo_corregido.csv"))
...
p1 <- ggplot(df_panel, aes(x = FECHA, y = P_complejo_real, group = NUI_fact, color = NUI_fact)) +
  ...
  theme_paper
print(p1)
ggsave(here::here("outputs", "figures", "grafico_tendencia_precios.png"), plot = p1, width = 10, height = 6, dpi = 300)
...
p2 <- df_panel %>%
  ...
  theme_paper
print(p2)
ggsave(here::here("outputs", "figures", "grafico_estacionalidad_desembarques.png"), plot = p2, width = 8, height = 5, dpi = 300)
...
p3 <- ggplot(df_panel, aes(x = P_FOB_REAL, y = P_complejo_real)) +
  ...
  theme_paper
print(p3)
ggsave(here::here("outputs", "figures", "grafico_dispersion_fob_local.png"), plot = p3, width = 7, height = 5, dpi = 300)
