...
df_panel <- read_csv(here::here("data", "panel_maestro_definitivo.csv"), show_col_types = FALSE)
...
df_biomasa <- read_excel(here::here("data", "biomass_para_costos.xlsx")) %>%
  rename(ANIO = year) %>%
  mutate(
...
write_csv(df_panel, here::here("data", "panel_maestro_integrado.csv"))
