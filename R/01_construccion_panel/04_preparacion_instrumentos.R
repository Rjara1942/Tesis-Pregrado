...
data_env <- read_csv(here::here("data", "data_env_puertos.csv"),
...
combustible_raw <- read_excel(
  here::here("data", "precios_combustibles.xlsx"), 
...
df_base <- read_csv(here::here("data", "base_integrada3.csv"), show_col_types = FALSE)
...
write_csv(df_final, here::here("data", "base_integrada3_IV.csv"))
write_csv(instrumentos_macro, here::here("data", "instrumentos_macrozonal.csv"))
write_csv(stats, here::here("outputs", "reportes_intermedios", "estadisticas_instrumentos.csv"))
...
print(g1)
ggsave(here::here("outputs", "figures", "grafico_evolucion_instrumentos.png"), g1, width = 10, height = 8)
...
print(g2)
ggsave(here::here("outputs", "figures", "grafico_precio_diesel_comparativo.png"), g2, width = 10, height = 6)
