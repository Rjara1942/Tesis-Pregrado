...
# Panel maestro
panel <- read_csv(here::here("data", "panel_maestro_integrado.csv"), show_col_types = FALSE)
cat("✓ Panel maestro:", nrow(panel), "obs ×", ncol(panel), "vars\n")

# FOB Perú (BCRP)
# El archivo tiene 2 filas de header, formato: "MesAño,Precio"
fob_peru_raw <- read_csv(here::here("data", "precio_peru.csv"), 
                          skip = 2, 
...
# Guardar
write_csv(panel_final, here::here("data", "panel_con_alternativas.csv"))
