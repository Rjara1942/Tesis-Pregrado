...
cat("=== CARGANDO DATOS ===\n")
df_env <- readRDS(here::here("data", "data_ambiental_por_puerto_15360263371915282388.RDS"))
...
# Guardar
ggsave(here::here("maps", "mapa_SST_real.png"), p_sst, width = 10, height = 12, dpi = 300, bg = "white")
ggsave(here::here("maps", "mapa_clorofila_real.png"), p_chl, width = 10, height = 12, dpi = 300, bg = "white")
ggsave(here::here("maps", "mapa_viento_real.png"), p_wind, width = 10, height = 12, dpi = 300, bg = "white")
ggsave(here::here("maps", "mapa_salinidad_real.png"), p_so, width = 10, height = 12, dpi = 300, bg = "white")
...
ggsave(here::here("maps", "mapa_panel_completo_real.png"), panel,
