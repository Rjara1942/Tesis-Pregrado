...
df <- read_csv(here::here("data", "base_integrada_macrozonal_v3.csv"),
...
print(p1)
ggsave(here::here("outputs", "figures", "distribucion_precios.png"), p1, width = 14, height = 5, dpi = 300, bg = "white")
...
print(p2)
ggsave(here::here("outputs", "figures", "estacionalidad_precios.png"), p2, width = 14, height = 5, dpi = 300, bg = "white")
...
print(p3)
ggsave(here::here("outputs", "figures", "evolucion_precios.png"), p3, width = 12, height = 10, dpi = 300, bg = "white")
...
print(p4)
ggsave(here::here("outputs", "figures", "scatter_precio_cantidad.png"), p4, width = 14, height = 5, dpi = 300, bg = "white")
