...
proc <-read_excel(here::here("data", "2025.04.21.pelagicos_proceso-precios.mp.2012-2024.xlsx"),
  sheet = "PROCESO"
)
...
ggsave(
  here::here("outputs", "figures", "sankey_composicion_especies_plantas.png"),
  plot = p,
  width = 10,
  height = 7,
  dpi = 300,
...
ggsave(
  here::here("outputs", "figures", "sankey_composicion_especies_plantas.pdf"),
  plot = p,
  width = 10,
  height = 7,
  bg = "#fafaf7"
